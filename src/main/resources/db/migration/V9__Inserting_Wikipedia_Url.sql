...
SET wikipedia_profile_url = CASE 
    WHEN id = 3 THEN 'https://en.wikipedia.org/wiki/Ayrton_Senna'
    WHEN id = 4 THEN 'https://en.wikipedia.org/wiki/Leonardo_da_Vinci'
    WHEN id = 5 THEN 'https://en.wikipedia.org/wiki/Indira_Gandhi'
    WHEN id = 6 THEN 'https://en.wikipedia.org/wiki/Mahatma_Gandhi'
